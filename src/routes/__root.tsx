...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Amaya — Restaurant · Cigar Lounge · Events · Rothenburg LU" },
      { name: "twitter:description", content: "Restaurant, Cigar Lounge, Bar und Events unter einem Dach. Modernste Küche und Nightlife im Jungle-Ambiente — mitten in Rothenburg, Luzern." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Syne:wght@400;500;600;700;800&family=Plus+Jakarta+Sans:wght@300;400;500;600;700&family=Italiana&family=Playfair+Display:wght@400;500;600;700&family=Inter:wght@300;400;500;600;700&display=swap",
      },
    ],
    scripts: [
      {
      ...
      <body>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=969507529160651&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        <Scripts />
